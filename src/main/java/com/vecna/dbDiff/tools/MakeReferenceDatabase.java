...
public class MakeReferenceDatabase extends ToolsCommon {
  ...
  public void run(String url, String username, String pw, String filename, String jdbcDriver) throws Exception {
  ...
  public static void main(String[] args) throws Exception {
    //Params
	  StringBuilder url = new StringBuilder("jdbc:mysql://localhost:3306/database1");
	    StringBuilder username = new StringBuilder("root");
	    StringBuilder pw = new StringBuilder("root");
